  ...
  return (
    <div className="m-[3%]">
      <div className="flex gap-3  max-[1100px]:flex-col">
        ...
        <div className="w-1/2 h-full mb-11 border border-[#7E7E7E]  max-[1100px]:w-full rounded-lg px-[1%] pb-[5%]">
          ...
          <div className="px-[2%] py-[5%]">
            ...
            <div className="border-b border-b-gray-300">
              <div className="flex justify-between px-[2%] py-4">
                ...
                <div className="">
                  <button className="px-11 py-2 bg-green-500 text-white rounded-md">
                    Pay
                  </button>
                </div>
              </div>
